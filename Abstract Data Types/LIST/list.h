...
/*
* Instantiates a new variable of type List. Time complexity: O(x).
* @return New, empty list. Must be released with freeList()
*/
List newList(void);

/*
* @param Li List object. Time complexity: O(x).
* @return Number of elements in the list.
*/
int listSize(List Li);

/*
* Checks if list is empty. Time complexity: O(x).
...
/*
* Adds an element to the end of the list. Time complexity: O(x).
* @param Li List object.
...
/*
* Adds an element at the specified position in the list. Time complexity: O(x).
* @param Li List object.
...
/*
* Removes the element at the specified position in the list. Time complexity: O(x).
* @param Li List object.
* @param position List position of an element.
...
/*
* Reverses the list (e.g, [a b c d] becomes [d c b a]). Time complexity: O(x).
* @param Li List object.
*/
void listReverse(List Li);

/*
* Prints the list to the standard output file. Time complexity: O(x).
* @param Li List object.
...
/*
* Desalocates all memory used by the list object. If function is passed, all elements in the list are also desalocated from memory. Time complexity: O(x).
* @param Li List object.
